...
function preload() {
  img = loadImage("/p5js/assets/man.jpg");
}
...
function setup() {
  ...
  startButton.mouseOver(() => startButton.style('background', '#00cc00'));
  startButton.mouseOut(() => startButton.style('background', '#00ff00'));
}

function startAudio() {
  if (!audioStarted) {
    console.log('🎤 Select BlackHole 2ch!');
