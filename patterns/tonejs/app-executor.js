...
// Tone.js Version - EXECUTOR COMPATIBLE
// Attack Magazine Layered Kick Technique
// ========================================
// This version works in the code executor (no exports, no DOM, direct execution)
...
// NOTE: Samples may not be available in executor context
// Using MembraneSynth for kicks instead of samples
...
// Update transpose every 4 measures
new Tone.Loop(() => {
  bassTransposeIndex++;
}, '4m').start(0);
...
console.log('🔊 BERLIN TECHNO - 157 BPM initialized and playing!');
