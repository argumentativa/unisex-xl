...
```
✓ Removed: patterns/strudel/track-1/ (empty after file relocation)
...
```
FROM: patterns/strudel/track-1/advanced-mixed-principles.js
TO:   patterns/tonejs/track-1/advanced-mixed-principles.js

FROM: patterns/strudel/track-1/em-202bpm-dnb.js
TO:   patterns/tonejs/track-1/em-202bpm-dnb.js
```
...
- docs/reference/*
- docs/guides/.gitkeep
- patterns/tonejs/track-1/* (additional files)
```
...
**Strudel patterns go in:** `patterns/strudel/{category}/`
- Use `.strudel` extension for Strudel code
- Use `.js` only if hybrid/mixed code

**Tone.js patterns go in:** `patterns/tonejs/{track-name}/`
- Use `.js` extension
